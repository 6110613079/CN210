...
<br>**คำสั่งที่คอมพิวเตอร์เข้าใจ**
   ...
   *(ตัวอย่างการทำงานของ CPU)* 
   *(บรรทัดนี้คือ addressเพิ่มมาอีก 4 bytesจาก address ก่อนหน้า เป็น 0100000C คำสั่ง 00221820 โดยคอมพิวเตอร์ของ MIPS จะมองเป็น 32 bits ซึ่งเป็นฐาน 2 ดังนี้
   00000000001000100001100000100000 เมื่อคำสั่งนี้เข้ามาที่คอมพิวเตอร์ decoder จะทำการแปลคำสั่ง โดยจะมองที่ 6 bits แรก 
   ในคำสั่งนี้ 6 bits แรก คือ 000000 เป็นคำสั่ง add ซึ่งเป็น R-Format แบ่งเป็น 6 ส่วน 5 bits ถัดมาคือ 00001(register rs=1) 5 bits 
   ถัดมาคือ 00010(register rt=2)  5 bits ถัดมาคือ 00011 (register rd=3) 5 bits ถัดมาคือ 00000(shamt ในคำสั่งนี้ไม่ได้ใช้) 
   และ 6 bits สุดท้ายคือ 100000(func คือ Add) หลักการของ add คือ นำ register rs + register rt และนำผลลัพธ์ไปเก็บที่ register rd)*
